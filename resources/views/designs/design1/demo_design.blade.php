    ...
    <div class="min-h-screen relative mb-48">
        <div class="flex flex-col fixed bottom-0 w-full z-50">
            ...
            <div onClick="togglePlay()" class="flex flex-row-reverse bottom-0 ring-0 mr-5 mb-5 hover:cursor-pointer">
                ...
                {{-- <audio id="audio" src="/audio/wedding audio1.mp3" controls></audio> --}}
        ...
        <div class="flex flex-col h-screen">
            <div class="flex flex-col h-4/5 lg:flex-row">
                <img src="/img/web/wedding-g1665d32ca_1920.jpg" alt="wedding cover" class="lg:w-4/6">
                <div class="flex flex-col justify-between bg-blue-400 h-3/5 w-full md:h-3/6 lg:w-2/6 lg:h-full">
                    <div class="text-center pt-12 text-white">
                        ...
                        <p class="text-4xl py-3">Ucup & Putri</p>
                        <p class="text-xl">27 Februari 2022</p>
                    </div>
        ...
        <div class="flex flex-col min-h-screen">
            ...
            <div class="flex flex-col lg:flex-row lg:justify-around">
                <div class="flex flex-col mb-10">
                    <img class="rounded-full h-60 w-60 flex items-center justify-center border-4 border-blue-300 mx-auto" src="/img/web/wedding-g1665d32ca_1920.jpg" alt="groom">
                    <p class="text-center text-3xl">Ucup Surucup</p>
                    <p class="text-center text-xl">Putra ke 3 dari Bapak Bambang dan Ibu Bambang</p>
                </div>
                <div class="flex flex-col">
                    <img class="rounded-full h-60 w-60 flex items-center justify-center border-4 border-blue-300 mx-auto" src="/img/web/wedding-g1665d32ca_1920.jpg" alt="bride">
                    <p class="text-center text-3xl">Putri wulandari</p>
                    <p class="text-center text-xl">Putri ke 3 dari Bapak Bambang dan Ibu Bambang</p>
                </div>
        ...
        <div class="flex flex-col shadow-xl w-11/12 rounded-lg mx-auto border-2">
            ...
            <div class="flex flex-col items-center mb-7">
                ...
                <p class="font-bold">27 February 2022</p>
                <p>18:12 - 18:12 WIB</p>
                <i class="fas fa-map-marker-alt text-2xl hover:text-blue-400"></i>
                <p class="font-bold">Edelweiss Wedding Hall</p>
                <p class="block w-4/5 text-center text-xs">Sport Club Goldland Karawaci, Gedung Edelweiss no. 1 dan 2, West Panunggangan, Cibodas, Jl. Palem Raja Raya, Bencongan Indah, Kec. Klp. Dua, Tangerang City, Banten 15810</p>
            </div>
