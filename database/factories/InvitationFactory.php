...
class InvitationFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'wedding_date' => $this->faker->dateTimeInInterval($startDate = '+ 1 months', $endDate = '+ 3 months'),
            ...
            'reception_date' => $this->faker->dateTimeInInterval($startDate = '+ 1 months', $endDate = '+ 3 months'),
